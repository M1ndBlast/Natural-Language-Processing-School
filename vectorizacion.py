...
if not (os.path.exists('Corpus/corpus_attraction.pkl')):
	raise Exception('no se ha generado el corpus lematizado')
else:
	corpus_file = open ('Corpus/corpus_attraction.pkl','rb')
...
print(pd.DataFrame(data=X_test.toarray(), columns=vectorizador_binario_fit.get_feature_names_out()))
